...
<template>
    ...
    <!-- Mengatur title halaman menjadi "Manage Posts" menggunakan Inertia Head -->

    <AuthenticatedLayout>
        <!-- Menggunakan layout yang membutuhkan autentikasi untuk tampilan halaman -->
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Create Post
            </h2>
            <!-- Header halaman dengan judul "Create Post" -->
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <form @submit.prevent="submit">
                            <!-- Mencegah form melakukan submit tradisional dan memanggil fungsi submit -->
                            <div class="mb-4">
